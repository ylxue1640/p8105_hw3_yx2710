...
```
The `r ncol(accel_df)` variables that dataset contains are week, day_id, day, week_d,and 1440 activity counts for each minute of a 24-hour day starting at midnight and there are `r nrow(accel_df)` observations.
